...
export PRIVATE_AUTO_STASH="${PRIVATE_AUTO_STASH:-1}"
export PRIVATE_CREATE_PR="${PRIVATE_CREATE_PR:-1}"
export PRIVATE_PR_BASE_BRANCH="${PRIVATE_PR_BASE_BRANCH:-${PRIVATE_TARGET_BRANCH}}"
