    ...
    <section className={cardShell}>
      ...
      <div className={cardBody}>
        <div className="mb-4 space-y-2">
          <p className={label}>{t("admin.teamMembers.addFromOrgTitle")}</p>
          <p className={`text-xs ${muted}`}>{t("admin.teamMembers.addFromOrgHint")}</p>
          {noCandidatesReady ? (
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:gap-3">
            <div className="min-w-0 w-full flex-1 lg:min-w-[14rem]">
              <CustomSelect
                className="w-full"
                disabled={addCandidatesLoading || !hasAddCandidates}
            ...
            <Button
              ...
              disabled={!addCanAddMember || addLoading || addCandidatesLoading || !hasAddCandidates}
              type="button"
              variant="primary"
